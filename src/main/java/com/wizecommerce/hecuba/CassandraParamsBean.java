...
public class CassandraParamsBean {
	...
	public String toString() {
		return Objects.toStringHelper(this).add("ClusterName", getClustername()).add("LocationURLs", getLocationURLs()).add("KeySpace,", getKeyspace())
				.add("ThriftPorts", getThriftPorts()).add("ColumnFamily", getColumnFamily()).add("KeyType", getKeyType()).add("SIColumns", getSiColumns())
				.add("MaxColumnCount", getMaxColumnCount()).add("MaxSiColumnCount", getMaxSiColumnCount()).add("username", getUsername())
