...
public abstract class CassandraTestBase {
		...
		try {
			...
			for (int i = 0; i < m.length; i++) {
				...
				if (methodName.startsWith("test")) {
					...
					if (excludeSecondaryIndexList == null || (excludeSecondaryIndexList != null && !excludeSecondaryIndexList.contains(methodName))) {
	...
	public CassandraParamsBean getDefaultCassandraParamsBean(String columnFamily) {
	...
	public HecubaClientManager<Long> getHecubaClientManager(String columnFamily) {
		CassandraParamsBean params = getDefaultCassandraParamsBean(columnFamily);
